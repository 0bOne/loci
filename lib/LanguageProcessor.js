...
//         this._rasterFilter = new RasterFilter(this._logger, this._options);
...
//             this._logger.ThreadProgress("Counting. Remaining: ", filesRemaining);
...
//             }
//             else if (this._options.raster === true && definition.raster)
//             {
//                 let statistics = this._rasterFilter.GetStatistics(fileInfo, definition);
